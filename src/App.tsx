 ...
 * SD NEGERI 3 LOLOAN TIMUR - JEMBRANA - KELAS V
 * Mata Pelajaran: MATEMATIKA (Persekutuan Faktor, KPK & FPB)
 */
...
const STORAGE_QUESTIONS_KEY = 'sd3_loloan_timur_kpk_fpb_v3';
  ...
  const [questions, setQuestions] = useState<Question[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Pastikan jumlah dan struktur sesuai dengan 30 soal (25 PG, 5 Benar/Salah)
